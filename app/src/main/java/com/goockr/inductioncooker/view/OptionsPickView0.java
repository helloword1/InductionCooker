...
/**
 * Created by LJN on 2017/8/29.
 */

public class OptionsPickView0<T> extends BasePickerView implements View.OnClickListener {
    ...
    //构造方法
    public OptionsPickView0(Builder builder) {
    ...
    public static class Builder {
        ...
        //Required
        public Builder(final Context context, OnOptionsSelectListener listener) {
        ...
        public OptionsPickView0 build() {
            return new OptionsPickView0(this);
        }
    }
