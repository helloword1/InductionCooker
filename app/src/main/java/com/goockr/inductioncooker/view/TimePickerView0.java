...
/**
 * Created by LJN on 2017/8/31.
 */

public class TimePickerView0  extends BasePickerView implements View.OnClickListener{
    ...
    //构造方法
    public TimePickerView0(Builder builder) {
    ...
    public static class Builder {
        ...
        public TimePickerView0 build() {
            return new TimePickerView0(this);
        }
    }
    ...
    public void returnData() {
        if (timeSelectListener != null) {
            try {
                ...
                String source = split1[0] + " "+split[1];
                Date date = WheelTime.dateFormat.parse(source);
